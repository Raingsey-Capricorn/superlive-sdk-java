...
@Log
@SpringBootTest
public class SDKClientPuttingHostTest {
    ...
    @SneakyThrows
    @Test
    public void testVersion01_PutANewHostUsingFileReaderFromJsonData() {
    ...
    @SneakyThrows
    @Test
    public void testVersion01_PutANewHostUsingHashMapSetup() {
